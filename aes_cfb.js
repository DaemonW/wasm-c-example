...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_nativeAesEnc')) {
        Object.defineProperty(Module['ready'], '_nativeAesEnc', { configurable: true, get: function() { abort('You are getting _nativeAesEnc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_nativeAesEnc', { configurable: true, set: function() { abort('You are setting _nativeAesEnc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_nativeAesDec')) {
        Object.defineProperty(Module['ready'], '_nativeAesDec', { configurable: true, get: function() { abort('You are getting _nativeAesDec on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_nativeAesDec', { configurable: true, set: function() { abort('You are setting _nativeAesDec on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_nativeModify')) {
        Object.defineProperty(Module['ready'], '_nativeModify', { configurable: true, get: function() { abort('You are getting _nativeModify on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_nativeModify', { configurable: true, set: function() { abort('You are setting _nativeModify on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _nativeModify = Module["_nativeModify"] = createExportWrapper("nativeModify");

/** @type {function(...*):?} */
var _nativeAesEnc = Module["_nativeAesEnc"] = createExportWrapper("nativeAesEnc");

/** @type {function(...*):?} */
var _nativeAesDec = Module["_nativeAesDec"] = createExportWrapper("nativeAesDec");
